...
**Last updated**: 2026-05-22T12:42:20Z
...
- Fixes the validation of the feature gates by ensuring the validation only happens after enforcing the feature gates provided by the user. (#11288, @MaysaMacedo)
...
- MultiKueue: Add reconnect backoff guardrail to suppress redundant cluster reconciles for MultikueueCluster reconciler (#11276, @reruno)
