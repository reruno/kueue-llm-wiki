# Issue #3302: Release v0.9.0

**Summary**: Release v0.9.0

**Sources**: https://github.com/kubernetes-sigs/kueue/issues/3302

**Last updated**: 2024-11-05T23:36:18Z
...
- **Created**: 2024-10-24T10:58:29Z
- **Updated**: 2024-11-05T23:36:18Z
- **Closed**: 2024-11-05T23:36:16Z
- **Labels**: _none_
...
- [x] Update the release branch:
  ...
  - [x] Submit a pull request with the changes: #3458
...
- [x] Submit a PR against [k8s.io](https://github.com/kubernetes/k8s.io),
      ...
      to production: kubernetes/k8s.io#7486
...
- [x] Update the `main` branch :
  ...
  - [x] Submit a pull request with the changes: #3461
...
- [x] For a major or minor release, prepare the repo for the next version:
  ...
  - [x] Create a milestone for the next minor release and update prow to set it automatically for new PRs:
        https://github.com/kubernetes/test-infra/pull/33759
  - [x] Create the presubmits jobs for the next patch release:
        https://github.com/kubernetes/test-infra/pull/33760
...
### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2024-10-24T13:49:32Z

+1

### Comment by [@mimowo](https://github.com/mimowo) — 2024-10-24T13:53:25Z
...
### Comment by [@alculquicondor](https://github.com/alculquicondor) — 2024-10-24T15:42:34Z

+1

### Comment by [@mimowo](https://github.com/mimowo) — 2024-11-05T15:07:50Z

I've updated the release notes, compared to v0.9.0-rc.1 the new entries are:
- ProvisioningRequestConfig API has now `RetryStrategy` field that allows users to configure retries per ProvisioningRequest class. By default retry releases allocated quota in Kueue. (#3375, @PBundyra)
- Account for NumOfHosts when calculating PodSet assignments for RayJob and RayCluster (#3384, @andrewsykim)

### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2024-11-05T23:36:12Z

All has been completed. Thank you!
/close

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2024-11-05T23:36:17Z

@tenzen-y: Closing this issue.

<details>

In response to [this](https://github.com/kubernetes-sigs/kueue/issues/3302#issuecomment-2458412462):
