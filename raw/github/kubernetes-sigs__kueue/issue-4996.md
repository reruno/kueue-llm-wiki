# Issue #4996: Release v0.11.4

**Summary**: Release v0.11.4

**Sources**: https://github.com/kubernetes-sigs/kueue/issues/4996

**Last updated**: 2025-04-24T21:09:06Z
...
- **Created**: 2025-04-16T08:31:54Z
- **Updated**: 2025-04-24T21:09:06Z
- **Closed**: 2025-04-24T21:09:04Z
- **Labels**: _none_
...
- [ ] Update the release branch:
  ...
  - [x] Submit a pull request with the changes:
      - [x] https://github.com/kubernetes-sigs/kueue/pull/5090
      - [x] https://github.com/kubernetes-sigs/kueue/pull/5094
      - [x] https://github.com/kubernetes-sigs/kueue/pull/5095
...
- [x] Submit a PR against [k8s.io](https://github.com/kubernetes/k8s.io) to
      ...
      to production: https://github.com/kubernetes/k8s.io/pull/8034
  - [x] Update `registry.k8s.io/images/k8s-staging-kueue/images.yaml`.
- [x] Wait for the PR to be merged and verify that the image `registry.k8s.io/kueue/kueue:$VERSION` is available.
- [x] Publish the draft release prepared at the [GitHub releases page](https://github.com/kubernetes-sigs/kueue/releases).
      Link: https://github.com/kubernetes-sigs/kueue/releases/tag/v0.11.4
...
- [x] Update the `main` branch :
  ...
  - [x] Submit a pull request with the changes: https://github.com/kubernetes-sigs/kueue/pull/5112
...
### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-04-16T08:36:48Z

+1

### Comment by [@mimowo](https://github.com/mimowo) — 2025-04-16T11:32:47Z

cc @mwysokin @mwielgus  @dgrove-oss @kannon92
We are aiming with @tenzen-y for the release on April 23.

### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-04-24T20:00:51Z

```shell
$ docker run -it registry.k8s.io/kueue/kueue:v0.11.4
Unable to find image 'registry.k8s.io/kueue/kueue:v0.11.4' locally
v0.11.4: Pulling from kueue/kueue
Digest: sha256:d9e487ade75db13f367e1a071bef4ff5fa608c7ea696e8f60836af8af22b89a9
Status: Downloaded newer image for registry.k8s.io/kueue/kueue:v0.11.4

...

{"level":"info","ts":"2025-04-24T19:59:17.979025755Z","logger":"setup","caller":"kueue/main.go:146","msg":"Initializing","gitVersion":"v0.11.4","gitCommit":"74a9dfc91cc1caf7a0ddb283e2972cd49de32e02"}
```

```shell
$ helm template oci://registry.k8s.io/kueue/charts/kueue --version 0.11.4 | grep registry.k8s.io
...
### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-04-24T21:09:00Z

Completed, thank you for all!
/close

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2025-04-24T21:09:05Z

@tenzen-y: Closing this issue.

<details>

In response to [this](https://github.com/kubernetes-sigs/kueue/issues/4996#issuecomment-2828864983):
