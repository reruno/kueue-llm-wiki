# Issue #5885: Release v0.11.8

**Summary**: Release v0.11.8

**Sources**: https://github.com/kubernetes-sigs/kueue/issues/5885

**Last updated**: 2025-07-09T16:39:23Z
...
- **Created**: 2025-07-07T07:41:44Z
- **Updated**: 2025-07-09T16:39:23Z
- **Closed**: 2025-07-09T16:39:22Z
- **Labels**: _none_
...
- [x] Update the release branch:
  ...
  - [x] Submit a pull request with the changes: https://github.com/kubernetes-sigs/kueue/pull/5912
...
- [x] Submit a PR against [k8s.io](https://github.com/kubernetes/k8s.io) to
      ...
      to production: https://github.com/kubernetes/k8s.io/pull/8283
  - [x] Update `registry.k8s.io/images/k8s-staging-kueue/images.yaml`.
- [x] Wait for the PR to be merged and verify that the image `registry.k8s.io/kueue/kueue:$VERSION` is available.
- [x] Publish the draft release prepared at the [GitHub releases page](https://github.com/kubernetes-sigs/kueue/releases).
      Link: https://github.com/kubernetes-sigs/kueue/releases/tag/v0.11.8
...
- [ ] Update the `main` branch :
  ...
  - [x] Submit a pull request with the changes: https://github.com/kubernetes-sigs/kueue/pull/5913
...
### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-07-08T15:02:57Z

+1

### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-07-09T15:50:13Z

I confirmed the promoted image.

```shell
$ docker run --rm registry.k8s.io/kueue/kueue:v0.11.8
Unable to find image 'registry.k8s.io/kueue/kueue:v0.11.8' locally
v0.11.8: Pulling from kueue/kueue
ee4ae02771ef: Pull complete 
Digest: sha256:d264f695ad01dbdc5e239987de6643da6e6598b1e77190bfc7ba0d06d4181164
Status: Downloaded newer image for registry.k8s.io/kueue/kueue:v0.11.8
...
{"level":"info","ts":"2025-07-09T15:48:33.290002884Z","logger":"setup","caller":"kueue/main.go:146","msg":"Initializing","gitVersion":"v0.11.8","gitCommit":"849f056c1849126bdef29d734235f0d35999b18b"}

$ helm template oci://registry.k8s.io/kueue/charts/kueue --version 0.11.8 | grep registry.k8s.io
Pulled: registry.k8s.io/kueue/charts/kueue:0.11.8
Digest: sha256:04198cb02e4dfd140ebbfeab6c7386482f11ac0acc04337e4754ba1626c50808
        image: "registry.k8s.io/kueue/kueue:v0.11.8"
```

### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2025-07-09T16:39:17Z

Done.
/close

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2025-07-09T16:39:23Z

@tenzen-y: Closing this issue.

<details>

In response to [this](https://github.com/kubernetes-sigs/kueue/issues/5885#issuecomment-3053314976):
