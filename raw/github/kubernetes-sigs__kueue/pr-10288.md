# PR #10288: Refactor scheduler unit tests

**Summary**: Refactor scheduler unit tests

**Sources**: https://github.com/kubernetes-sigs/kueue/pull/10288

**Last updated**: 2026-04-07T07:52:46Z
...
- **Branch**: `scheduler-dedup` → `main`
- **Created**: 2026-04-03T07:43:23Z
- **Updated**: 2026-04-07T07:52:46Z
- **Merged**: 2026-04-07T07:51:30Z
- **Closed**: 2026-04-07T07:51:30Z
...
This PR reduces `pkg/scheduler/scheduler_test.go` by splitting the file into `pkg/scheduler/scheduler_fs_test.go`.
...
### Comment by [@netlify[bot]](https://github.com/apps/netlify) — 2026-04-03T07:43:30Z
...
|  Name | Link |
|:-:|------------------------|
|<span aria-hidden="true">🔨</span> Latest commit | 3937471c133e3f804024aad1b85811a65cf29b28 |
|<span aria-hidden="true">🔍</span> Latest deploy log | https://app.netlify.com/projects/kubernetes-sigs-kueue/deploys/69d3587583823e0008d1c490 |

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2026-04-03T07:43:34Z
...
### Comment by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-03T08:38:21Z

/ok-to-test

### Comment by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-04T07:22:10Z

Known flake: #9582
/test pull-kueue-populator-test-e2e-main

### Comment by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T06:24:44Z
...
### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2026-04-06T06:24:51Z

LGTM label has been added.  <details>Git tree hash: 4056ff9ddc15dc448be943a90b2cd9e743382ec0</details>

### Comment by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-06T07:50:11Z


/test pull-kueue-test-e2e-tas-main

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2026-04-07T07:06:25Z

LGTM label has been added.  <details>Git tree hash: c2cf274371ae1904bd32c4b39a6bd782a2894f31</details>

### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2026-04-07T07:06:27Z

[APPROVALNOTIFIER] This PR is **APPROVED**

This pull-request has been approved by: *<a href="https://github.com/kubernetes-sigs/kueue/pull/10288#issuecomment-4190677706" title="Approved">mbobrovskyi</a>*, *<a href="https://github.com/kubernetes-sigs/kueue/pull/10288#" title="Author self-approved">ShaanveerS</a>*, *<a href="https://github.com/kubernetes-sigs/kueue/pull/10288#pullrequestreview-4066313075" title="Approved">tenzen-y</a>*
...
### Comment by [@tenzen-y](https://github.com/tenzen-y) — 2026-04-07T07:19:18Z

/cherrypick release-0.17

Let's cherry pick this to release-0.17 to avoid large merge conflicts.

cc @mimowo @gabesaba

### Comment by [@k8s-infra-cherrypick-robot](https://github.com/k8s-infra-cherrypick-robot) — 2026-04-07T07:19:22Z

@tenzen-y: once the present PR merges, I will cherry-pick it on top of `release-0.17` in a new PR and assign it to you.

<details>

In response to [this](https://github.com/kubernetes-sigs/kueue/pull/10288#issuecomment-4197216127):
...
### Comment by [@mimowo](https://github.com/mimowo) — 2026-04-07T07:39:51Z

Let's cherrypick. There is no risk, and the future cherrypicks will be much easier.
/cherrypick release-0.17
/cherrypick release-0.16

### Comment by [@k8s-infra-cherrypick-robot](https://github.com/k8s-infra-cherrypick-robot) — 2026-04-07T07:39:54Z
...
In response to [this](https://github.com/kubernetes-sigs/kueue/pull/10288#issuecomment-4197331325):
...
### Comment by [@mimowo](https://github.com/mimowo) — 2026-04-07T07:40:57Z

@ShaanveerS if the cherrypick bot fails due to conflicts please prepare the cherrypick PRs using manually. I recommend the ./hack/cherry_pick_pull.sh script for that

### Comment by [@k8s-infra-cherrypick-robot](https://github.com/k8s-infra-cherrypick-robot) — 2026-04-07T07:52:11Z

@tenzen-y: new pull request created: #10309
...
### Comment by [@k8s-infra-cherrypick-robot](https://github.com/k8s-infra-cherrypick-robot) — 2026-04-07T07:52:46Z

@mimowo: #10288 failed to apply on top of branch "release-0.16":
```
Applying: Split fair-sharing scheduler tests
...
Patch failed at 0001 Split fair-sharing scheduler tests
...
### Review by [@tenzen-y](https://github.com/tenzen-y) (commented) — 2026-04-03T09:48:22Z

- **pkg/scheduler/scheduler_test.go:115** by [@tenzen-y](https://github.com/tenzen-y) — 2026-04-03T09:48:20Z
```diff
@@ -67,6 +67,53 @@ var cmpDump = cmp.Options{
 	cmpopts.SortSlices(func(a, b string) bool { return a < b }),
 }
 
+func workloadCondition(conditionType string, status metav1.ConditionStatus, reason, message string, now time.Time) metav1.Condition {
...
+}
+
+func workloadConditionWithObservedGeneration(conditionType string, status metav1.ConditionStatus, reason, message string, observedGeneration int64, now time.Time) metav1.Condition {
+	condition := workloadCondition(conditionType, status, reason, message, now)
+	condition.ObservedGeneration = observedGeneration
+	return condition
+}
+
+func workloadQuotaReservedAndAdmittedConditions(clusterQueue kueue.ClusterQueueReference, now time.Time) []metav1.Condition {
+	return []metav1.Condition{
+		workloadCondition(kueue.WorkloadQuotaReserved, metav1.ConditionTrue, "QuotaReserved", fmt.Sprintf("Quota reserved in ClusterQueue %s", clusterQueue), now),
+		workloadCondition(kueue.WorkloadAdmitted, metav1.ConditionTrue, "Admitted", "The workload is admitted", now),
+	}
+}
+
+func workloadQuotaReservedAndAdmittedConditionsWithObservedGeneration(clusterQueue kueue.ClusterQueueReference, observedGeneration int64, now time.Time) []metav1.Condition {
+	return []metav1.Condition{
+		workloadConditionWithObservedGeneration(kueue.WorkloadQuotaReserved, metav1.ConditionTrue, kueue.WorkloadQuotaReserved, fmt.Sprintf("Quota reserved in ClusterQueue %s", clusterQueue), observedGeneration, now),
+		workloadConditionWithObservedGeneration(kueue.WorkloadAdmitted, metav1.ConditionTrue, kueue.WorkloadAdmitted, "The workload is admitted", observedGeneration, now),
+	}
+}
+
+func singleResourceRequest(name kueue.PodSetReference, resourceName corev1.ResourceName, quantity string) kueue.PodSetRequest {
+	return kueue.PodSetRequest{
+		Name: name,
...
+}
+
+func singlePodSetAdmission(clusterQueue kueue.ClusterQueueReference, podSetName kueue.PodSetReference, resourceName corev1.ResourceName, flavor kueue.ResourceFlavorReference, quantity string, count ...int32) *kueue.Admission {
+	assignment := utiltestingapi.MakePodSetAssignment(podSetName).Assignment(resourceName, flavor, quantity)
+	if len(count) > 0 {
+		assignment = assignment.Count(count[0])
+	}
+	return utiltestingapi.MakeAdmission(string(clusterQueue)).PodSets(assignment.Obj()).Obj()
+}
```

  I don't think that we should introduce such programmable functions for this file.
  The redundant structures help us to understand each test case by checking only each case without a definition jump.
  
  Please see our contribution guide: https://github.com/kubernetes-sigs/kueue/blob/main/CONTRIBUTING.md

### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-03T10:14:36Z

- **pkg/scheduler/scheduler_test.go:115** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-03T10:14:36Z
```diff
@@ -67,6 +67,53 @@ var cmpDump = cmp.Options{
 	cmpopts.SortSlices(func(a, b string) bool { return a < b }),
 }
...
```
  ...
  Then I think the better direction is to split the file into smaller ones,, similar to AFS and TAS.
  Does that sound better?

### Review by [@tenzen-y](https://github.com/tenzen-y) (commented) — 2026-04-03T17:26:34Z

- **pkg/scheduler/scheduler_test.go:115** by [@tenzen-y](https://github.com/tenzen-y) — 2026-04-03T17:26:34Z
```diff
@@ -67,6 +67,53 @@ var cmpDump = cmp.Options{
 	cmpopts.SortSlices(func(a, b string) bool { return a < b }),
 }
...
```
  ...
  @ShaanveerS Yes, I think so too.
  As a first step, I'm wondering if we can decouple fair sharing cases from `TestScheduler` to `TestSchedulerForFairSharing` (`scheduler_fs_test.go`).
  
  Could you try that?

### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-04T06:37:14Z

- **pkg/scheduler/scheduler_test.go:115** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-04T06:37:14Z
```diff
@@ -67,6 +67,53 @@ var cmpDump = cmp.Options{
 	cmpopts.SortSlices(func(a, b string) bool { return a < b }),
 }
...
### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:50:11Z

- **pkg/scheduler/scheduler_test.go:2847** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:50:11Z
```diff
@@ -2843,2281 +2843,7 @@ func TestSchedule(t *testing.T) {
 				"cq_a": {"eng-alpha/a"},
 			},
 		},
...
```
  ...
  So, we can remove this option here now, right?

### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:53:13Z

- **pkg/scheduler/scheduler_fs_test.go:158** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:53:13Z
```diff
@@ -0,0 +1,3531 @@
+/*
...
```
  ...
  I think this option should be enabled in all tests, right?

### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:54:31Z

- **pkg/scheduler/scheduler_fs_test.go:3425** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:54:31Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
```
  ...
  ```suggestion
  				scheduler := New(qManager, cqCache, cl, recorder,
  					WithFairSharing(&config.FairSharing{}), WithClock(t, fakeClock), WithPreemptionExpectations(preemptexpectations.New()))
  ```
  ?

### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:55:42Z

- **pkg/scheduler/scheduler_fs_test.go:3127** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:55:42Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:57:07Z

- **pkg/scheduler/scheduler_fs_test.go:165** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:57:08Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:57:35Z

- **pkg/scheduler/scheduler_fs_test.go:160** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:57:36Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T05:58:45Z

- **pkg/scheduler/scheduler_fs_test.go:178** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-04-06T05:58:45Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@mbobrovskyi](https://github.com/mbobrovskyi) (commented) — 2026-04-06T06:05:32Z

Overall LGTM.

### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-06T06:19:19Z

- **pkg/scheduler/scheduler_test.go:2847** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-06T06:19:19Z
```diff
@@ -2843,2281 +2843,7 @@ func TestSchedule(t *testing.T) {
 				"cq_a": {"eng-alpha/a"},
 			},
...
### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-06T06:19:54Z

- **pkg/scheduler/scheduler_fs_test.go:165** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-06T06:19:54Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-06T06:20:02Z

- **pkg/scheduler/scheduler_fs_test.go:160** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-06T06:20:02Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@ShaanveerS](https://github.com/ShaanveerS) (commented) — 2026-04-06T06:20:15Z

- **pkg/scheduler/scheduler_fs_test.go:178** by [@ShaanveerS](https://github.com/ShaanveerS) — 2026-04-06T06:20:14Z
```diff
@@ -0,0 +1,3531 @@
+/*
+Copyright The Kubernetes Authors.
...
### Review by [@tenzen-y](https://github.com/tenzen-y) (commented) — 2026-04-07T07:06:17Z
