...
**Last updated**: 2026-05-11T16:01:03Z
...
|  Name | Link |
|:-:|------------------------|
|<span aria-hidden="true">🔨</span> Latest commit | 4b13c9b01e9a1a2b834a7f8f0c3097e49e749243 |
|<span aria-hidden="true">🔍</span> Latest deploy log | https://app.netlify.com/projects/kubernetes-sigs-kueue/deploys/69ff692a2d95d20008c37644 |
...
### Comment by [@k8s-ci-robot](https://github.com/k8s-ci-robot) — 2026-05-09T17:22:29Z
...
--- | --- | --- | --- | ---
pull-kueue-verify-main | 4b13c9b01e9a1a2b834a7f8f0c3097e49e749243 | [link](https://prow.k8s.io/view/gs/kubernetes-ci-logs/pr-logs/pull/kubernetes-sigs_kueue/10937/pull-kueue-verify-main/2053159298392920064) | true | `/test pull-kueue-verify-main`
...
- **pkg/controller/admissionchecks/multikueue/workload.go:809** by [@mimowo](https://github.com/mimowo) — 2026-05-07T19:16:09Z
```diff
...
- **pkg/controller/admissionchecks/multikueue/workload.go:772** by [@andrewseif](https://github.com/andrewseif) — 2026-05-08T14:21:17Z
```diff
@@ -757,21 +756,9 @@ func (w *wlReconciler) nominateAndSynchronizeWorkers(ctx context.Context, group
 	// supporting preferred or required placement constraints.
 	if clusterName := workload.ClusterName(group.local); group.IsElasticWorkload() && clusterName != "" {
...
- **pkg/controller/admissionchecks/multikueue/workload.go:809** by [@andrewseif](https://github.com/andrewseif) — 2026-05-08T14:22:37Z
```diff
@@ -788,6 +775,18 @@ func (w *wlReconciler) nominateAndSynchronizeWorkers(ctx context.Context, group
 				}
 			}
...
- **pkg/controller/admissionchecks/multikueue/workload.go:809** by [@olekzabl](https://github.com/olekzabl) — 2026-05-08T22:49:13Z
```diff
@@ -788,6 +775,18 @@ func (w *wlReconciler) nominateAndSynchronizeWorkers(ctx context.Context, group
 				}
 			}
...
- **pkg/controller/admissionchecks/multikueue/workload.go:809** by [@andrewseif](https://github.com/andrewseif) — 2026-05-09T21:25:01Z
```diff
@@ -788,6 +775,18 @@ func (w *wlReconciler) nominateAndSynchronizeWorkers(ctx context.Context, group
 				}
 			}
