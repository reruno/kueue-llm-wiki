...
**Last updated**: 2026-06-08T14:01:43Z
...
- **Updated**: 2026-06-08T14:01:43Z
- **Merged**: —
- **Closed**: —
- **Labels**: `kind/feature`, `release-note-none`, `size/XL`, `approved`, `do-not-merge/hold`, `cncf-cla: yes`
- **Assignees**: _none_
- **Requested reviewers**: [@kannon92](https://github.com/kannon92), [@kshalot](https://github.com/kshalot)
- **Changed files**: 6   **+875 / -0**
...
|  Name | Link |
|:-:|------------------------|
|<span aria-hidden="true">🔨</span> Latest commit | a087334005d0c6ffff0482d70df83014883225c4 |
|<span aria-hidden="true">🔍</span> Latest deploy log | https://app.netlify.com/projects/kubernetes-sigs-kueue/deploys/6a26ca32a9c9770007766efd |
...
- **cmd/experimental/webhook-conversion-repro/main.go:215** by [@coderabbitai[bot]](https://github.com/apps/coderabbitai) — 2026-06-05T08:52:16Z
```diff
@@ -0,0 +1,214 @@
+/*
+Copyright The Kubernetes Authors.
...
- **cmd/experimental/webhook-conversion-repro/repro.sh:203** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-06-05T14:34:33Z
```diff
@@ -0,0 +1,395 @@
+#!/bin/bash
+# Copyright The Kubernetes Authors.
...
- **cmd/experimental/webhook-conversion-repro/repro.sh:203** by [@mykysha](https://github.com/mykysha) — 2026-06-08T08:18:39Z
```diff
@@ -0,0 +1,395 @@
+#!/bin/bash
+# Copyright The Kubernetes Authors.
...
- **cmd/experimental/webhook-conversion-repro/main.go:189** by [@mbobrovskyi](https://github.com/mbobrovskyi) — 2026-06-08T13:25:03Z
```diff
@@ -0,0 +1,224 @@
+/*
+Copyright The Kubernetes Authors.
...
- **cmd/experimental/webhook-conversion-repro/main.go:189** by [@mykysha](https://github.com/mykysha) — 2026-06-08T13:58:11Z
```diff
@@ -0,0 +1,224 @@
+/*
+Copyright The Kubernetes Authors.
