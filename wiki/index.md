...
**Sources**: `raw/github/kubernetes-sigs__kueue/` (scraped issues and PRs from `kubernetes-sigs/kueue`, through 2026-06) and `raw/cve/` (Kubernetes-ecosystem CVE corpus).
